...
public interface ApiService {
    ...
    // --- CHAT APIs ---
    @GET("/api/chats/chat-or-create")
    Call<ChatResponse<Chat>> getOrCreateChat(@Header("Authorization") String token);
    @POST("/api/chats/message")
    Call<MessageResponse> sendMessage(@Header("Authorization") String token, @Body MessageRequest request);

    //--RECOMMENDATION
    @GET("/api/recommend/home")
    Call<RecommendHomeResponse> getHomeRecommend(@Header("Authorization") String token);

    @POST("api/recommend/cart")
    Call<CartRecommendResponse> getCartRecommend(@Header("Authorization") String token, @Body CartRecommendRequest request);
